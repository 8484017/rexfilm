...
var ImageWorker = /** @class */ (function () {
    function ImageWorker(url) {
        this.url = url;
    }
    ImageWorker.prototype.loadFileAsync = function () {
    ...
    ImageWorker.prototype.imageSave = function (dest, name, maxSize) {
